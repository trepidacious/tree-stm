...
lazy val root = project.in(file(".")).
  aggregate(treeSTMJS, treeSTMJVM).
  settings(
    publish := {},
    publishLocal := {}
  )

lazy val treeSTM = crossProject.in(file(".")).
  settings(
    name := "treeSTM",
...
lazy val treeSTMJVM = treeSTM.jvm
lazy val treeSTMJS = treeSTM.js
